...
import de.unihalle.informatik.bigdata.millionsongdataset.analysis.mapreduce.map.MapArtistFamiliarity
...
object AnalyseArtistFamiliarity : IoTool() {
    ...
    override fun onRun(arguments: Array<String>): Boolean {
        ...
        return jobOf(configuration) {
            ...
            mapperKClass = MapArtistFamiliarity::class
